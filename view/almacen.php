...
<div id="content" class="app-content box-shadow-z0" role="main">
    ...
    <div ui-view class="app-body" id="view">
        ...
        <div class="box" id="creacion">
            ...
            <div class="row" id="registroAlmacen">
                <div class="col-sm-12">
                    <form ui-jp="parsley" novalidate="" id="formulario">
                        <div class="box">
                            <div class="box-header">
                                <h2>Registro de Nuevo Almacen</h2>
                            </div>
                            <div class="box-body">
                                <div class="row m-b">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <br>
                                        <select class="form-control select2" ui-jp="select2" ui-options="{theme: 'bootstrap'}" id="idlocacion">
                                            
                                        </select>
                                    </div>
                                </div>
                                <button class="md-btn md-raised green" type="button" onclick="guardarAlmacen()">Guardar</button>
                            </div>
                        </div>
                    </form>
                </div>
