        ...
        <div class="box" id="creacion">
            ...
            <div class="box" id="tablaListada">
                ...
                <div class="table-responsive">
                    ...
                    <thead>
                    <tr>
                        <th  style="width:40%">N categoria</th>
            ...
            <div class="row" id="registroCategoria">
                <div class="col-sm-12">
                    <form ui-jp="parsley" novalidate="">
                        <div class="box">
                            <div class="box-header">
                                <h2>Registro de Nueva Categoria</h2>
                            </div>
                            <div class="box-body">
                                <div class="row m-b">
                                    <div class="col-sm-6">
                                        <input type="hidden" class="form-control" id="idcategoria" data-parsley-id="151">
                                        <label>Nombre categoria</label>
                                        <input type="text" class="form-control" id="nombrecategoria" placeholder="Ingrese el nombre" required="" data-parsley-id="151">
                                    </div>
