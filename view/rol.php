...
<div id="content" class="app-content box-shadow-z0" role="main">
    ...
    <div ui-view class="app-body" id="view">
        <div class="padding">
            ...
            <!-- Inicio del registro de un nuevo rol -->
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row m-b">
                                    ...
                                    <div class="col-sm-6">
                                        <label>Rol</label>
                                        <input type="text" class="form-control" id="nombrerol" placeholder="Ingrese el Rol" required="" data-parsley-id="151">
                                    </div>
                                ...
                                <button class="md-btn md-raised green" type="submit" onclick="guardar(e)">Guardar</button>
                            </div>
                        </div>
                    </form>
                </div>
