...
<div id="content" class="app-content box-shadow-z0" role="main">
    ...
    <div ui-view class="app-body" id="view">
        <div class="padding">
            ...
            <div class="row" id="registroUsuario">
                <div class="col-sm-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row m-b">
                                    ...
                                    <div class="col-sm-6">
                                        <label>Email</label>
                                        <input type="email" class="form-control" id="correo" placeholder="Ingrese el Email" required="" data-parsley-id="153">
                                    </div>
                                </div>
                                <div class="row m-b">
                                    <div class="col-sm-6">
                                        <label>Telefono</label>
                                        <input type="text" class="form-control" id="telefono" placeholder="Ingrese su telefono" required="" data-parsley-id="151">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>CI</label>
                                        <input type="text" class="form-control" id="ci" placeholder="Ingrese su CI" required="" data-parsley-id="151">
                                    </div>
                                </div>
                                <div class="row m-b">
                                    <div class="col-sm-6">
                                        <label>Usuario</label>
                                        <input type="text" class="form-control" id="usuario" placeholder="Ingrese su usuario" required="" data-parsley-id="151">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>Contraseña</label>
                                        <input type="text" class="form-control" id="contrasenia" placeholder="Ingrese su contraseña" required="" data-parsley-id="151">
                                    </div>
                                </div>
                                <div class="row m-b">
                                    <div class="col-sm-6">
                                        <label>Rol</label>
                                        <br>
                                        <select class="form-select form-control" id="rolSeleccionado">
